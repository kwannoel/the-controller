---
name: debugging-ui-with-playwright
...
**Don't skip to fixes.** Use the `systematic-debugging` skill's iron law: no fixes without root cause investigation first. This skill is the browser-specific investigation technique.
